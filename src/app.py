...
activities.update({
    ...
    "Soccer Club": {
        "description": "Recreational soccer training and friendly matches",
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["mia@mergington.edu", "oscar@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for regional science competitions and build experiments",
